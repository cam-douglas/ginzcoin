...
- **GINZ tokenomics (locked 2026-06-23, human-confirmed):** **≤ ~$20 USD all-in** (gas + LP); **1M GINZ** supply; **400k/300k/150k/150k** allocation; **~$8 USDC** LP → **~$20 FDV**. Assume these numbers in all work unless user overrides. Canonical: [`docs/plans/tokenomics-config.md`](docs/plans/tokenomics-config.md).

## Project index

- **GINZ token launch** — **≤ ~$20 all-in** cap; **1M supply**, **~$20 FDV**, LP **~$8 USDC** + 400k GINZ. Live site: https://ginzcoin-web.vercel.app
